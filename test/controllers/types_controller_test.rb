...
class TypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create type" do
    assert_difference('Type.count') do
      post types_url, params: { type: { chinese: @type.chinese, japanese: @type.japanese, type: @type.type } }
    end
  ...
  test "should update type" do
    patch type_url(@type), params: { type: { chinese: @type.chinese, japanese: @type.japanese, type: @type.type } }
