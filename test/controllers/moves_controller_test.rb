...
class MovesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create move" do
    assert_difference('Move.count') do
      post moves_url, params: { move: { name: @move.name, power: @move.power, pp: @move.pp, type: @move.type } }
    end
  ...
  test "should update move" do
    patch move_url(@move), params: { move: { name: @move.name, power: @move.power, pp: @move.pp, type: @move.type } }
